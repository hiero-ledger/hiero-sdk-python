...
class TopicMessageQuery:
    ...
    def __init__(
        ...
        self._start_time: Optional[Any] = self._parse_timestamp(start_time) if start_time else None
        self._end_time: Optional[Any] = self._parse_timestamp(end_time) if end_time else None
