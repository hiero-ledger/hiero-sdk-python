...
from hiero_sdk_python.contract.contract_create_transaction import ContractCreateTransaction, ContractCreateParams, DEFAULT_AUTO_RENEW_PERIOD
...
def test_build_transaction_body_with_bytecode_file_id(mock_account_ids, contract_params):
    ...
    assert transaction_body.contractCreateInstance.adminKey == contract_params["admin_key"].public_key()._to_proto()
...
def test_set_methods(contract_params):
    ...
    test_cases = [
        ('set_bytecode_file_id', contract_params["bytecode_file_id"], 'bytecode_file_id'),
        ('set_bytecode', contract_params["bytecode"], 'bytecode'),
        ('set_proxy_account_id', contract_params["proxy_account_id"], 'proxy_account_id'),
        ...
        ('set_auto_renew_period', contract_params["auto_renew_period"], 'auto_renew_period'),
        ...
        ('set_auto_renew_account_id', contract_params["auto_renew_account_id"], 'auto_renew_account_id'),
        ('set_max_automatic_token_associations', contract_params["max_automatic_token_associations"], 'max_automatic_token_associations'),
        ('set_staked_account_id', contract_params["staked_account_id"], 'staked_account_id'),
...
def test_set_methods_require_not_frozen(mock_client, contract_params):
    ...
    test_cases = [
        ...
        ('set_max_automatic_token_associations', contract_params["max_automatic_token_associations"]),
...
def test_contract_create_transaction_can_execute():
    ...
    mock_receipt_proto = TransactionReceiptProto(
        ...
        contractID=basic_types_pb2.ContractID(
            shardNum=0,
            realmNum=0,
            contractNum=1234
        )
