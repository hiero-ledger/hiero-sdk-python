...
This file contains unit tests for creating contract update transactions,
validating various parameters and behaviors.

Coverage includes:
- Building transaction bodies with and without parameters
- Missing/invalid fields
- Method chaining
- Constructor parameter validation
- Edge cases and minimal operations
"""
