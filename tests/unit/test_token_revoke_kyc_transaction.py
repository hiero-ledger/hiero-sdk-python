...
def test_build_transaction_body(mock_account_ids):
    ...
    assert transaction_body.tokenRevokeKyc.token == token_id.to_proto()
    assert transaction_body.tokenRevokeKyc.account == account_id.to_proto()
