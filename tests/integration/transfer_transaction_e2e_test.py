...
def test_integration_transfer_transaction_can_transfer_hbar(env):
...
@pytest.mark.integration
def test_integration_token_transfer_transaction_can_transfer_token(env):
    new_account_private_key = PrivateKey.generate()
    new_account_public_key = new_account_private_key.public_key()
...
@pytest.mark.integration
def test_integration_token_transfer_transaction_can_transfer_nft(env):
    new_account_private_key = PrivateKey.generate()
    new_account_public_key = new_account_private_key.public_key()
...
@pytest.mark.integration
def test_integration_transfer_transaction_transfer_hbar_nothing_set(env):
    transfer_transaction = TransferTransaction()
...
@pytest.mark.integration
def test_integration_transfer_transaction_transfer_wrong_hbar_amount(env):
    new_account_private_key = PrivateKey.generate()
    new_account_public_key = new_account_private_key.public_key()
...
@pytest.mark.integration
def test_integration_transfer_transaction_transfer_hbar_fail_not_enough_balance(env):
    new_account_private_key = PrivateKey.generate()
    new_account_public_key = new_account_private_key.public_key()
...
@pytest.mark.integration
def test_integration_token_transfer_transaction_fail_not_enough_balance(env):
    new_account_private_key = PrivateKey.generate()
    new_account_public_key = new_account_private_key.public_key()
...
@pytest.mark.integration
def test_integration_token_transfer_transaction_fail_not_your_nft(env):
    new_account_private_key = PrivateKey.generate()
    new_account_public_key = new_account_private_key.public_key()
...
@pytest.mark.integration
def test_integration_transfer_transaction_approved_token_transfer(env):
    # Create new account
...
@pytest.mark.integration
def test_integration_transfer_transaction_approved_nft_transfer(env):
