...
- Added "Follow Us" section to README.md with instructions for watching, starring, and forking the repository
- Added social badges (stars, forks, watchers) to README.md
