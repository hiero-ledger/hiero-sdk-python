...
def _handle_key_list(params: KeyGenerationParams, response: KeyGenerationResponse, is_list: bool) -> str:
  key_list = KeyList()
...
def _handle_evm_address(params: KeyGenerationParams, response: KeyGenerationResponse, is_list: bool) -> str:
  if params.fromKey:
