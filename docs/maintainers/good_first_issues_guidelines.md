...
- [Allowed Categories](#allowed-categories)
  ...
  - [Print and Output Clarity](#️-print-and-output-clarity-examples-only)
  - [Functional Improvements to Examples](#️-functional-improvements-to-examples)
...
- [DCO Signing Guide](../sdk_developers/training/workflow/signing.md)
- [Changelog Entry Guide](../sdk_developers/training/workflow/changelog_entry.md)
