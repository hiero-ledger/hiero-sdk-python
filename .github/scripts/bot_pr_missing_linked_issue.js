  ...
  if (!regex.test(body)) {
    await github.rest.issues.createComment({
      ...
      body: [
        ...
        ``,
        `📖 Guide:`,
        `https://github.com/hiero-ledger/hiero-sdk-python/blob/main/docs/sdk_developers/how_to_link_issues.md`,
        ``,
        `If no issue exists yet, please create one:`,
        `https://github.com/hiero-ledger/hiero-sdk-python/blob/main/docs/sdk_developers/creating_issues.md`,
        ``,
        `Thanks!`
      ].join('\n')
    });
