...
`;
const messageSuffix = `Please read - [Creating Issues](docs/sdk_developers/creating_issues.md) - [How To Link Issues](docs/sdk_developers/training/workflow/how_to_link_issues.md)\n\nThank you,
