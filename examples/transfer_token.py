"""Run the transfer token example.
...
def associate_token(client, recipient_id, recipient_key, token_id):
    """Associate the token with the recipient."""
...
def transfer_tokens():
    """Run a full token transfer example.

    Create a new recipient account, a fungible token, and transfer the token to that account.
    """
    # Config Client
