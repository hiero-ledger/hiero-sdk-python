...
def update_token_data(client, token_id, new_metadata, token_name, token_symbol, token_memo):
...
def token_update_fungible():
    ...
    update_token_data(client, token_id, new_metadata, token_name, token_symbol, token_memo)
