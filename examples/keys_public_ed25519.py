"""Demonstrate Ed25519 PublicKey operations.
...
def example_load_ed25519_from_raw() -> None:
    """Create a PublicKey object from a 32-byte Ed25519 public key.
...
def example_load_ed25519_from_hex() -> None:
    """Create a PublicKey object from a 32-byte hex string.
...
def main():
    """Run the Ed25519 public key examples."""
