"""Demonstrate contract bytecode query on the network.

This module shows how to query a contract bytecode on the network.
...
def query_contract_bytecode():
    """Demonstrate querying a contract bytecode.
